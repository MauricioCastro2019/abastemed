...
-- Esta migración es aditiva — no elimina datos existentes
-- ============================================================

-- ============================================================
-- 1. EXPANDIR ENUM: agregar nuevos roles
-- ============================================================
...
-- ============================================================
-- 3. INSERTAR ORGANIZACIÓN POR DEFECTO (Abastemed)
--    UUID fijo para que la migración sea idempotente
-- ============================================================
...
-- ============================================================
-- 4. TABLA: portfolios (carteras de atención)
-- ============================================================
...
-- ============================================================
-- 5. AGREGAR organization_id A TABLAS PRINCIPALES
...
CREATE INDEX IF NOT EXISTS idx_levantamientos_org ON levantamientos(organization_id);
...
-- ============================================================
-- 7. MIGRAR jefe_enfermeros → coordinador
-- ============================================================
...
-- ============================================================
-- 8. ACTUALIZAR POLÍTICAS RLS: jefe_enfermeros → coordinador
--
-- Todas las políticas que aceptaban jefe_enfermeros ahora
-- aceptan coordinador con los mismos permisos.
-- ============================================================
...
-- ============================================================
-- 9. FUNCIÓN HELPER: organization_id del usuario actual
-- ============================================================
...
-- NOTA: Esta función devuelve la organización por defecto.
-- Cuando se implemente multi-organización real, se actualizará
-- para leer desde una tabla user_organizations.
